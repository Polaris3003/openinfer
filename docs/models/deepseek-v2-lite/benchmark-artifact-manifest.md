...
> **TL;DR:** Issue #467 is implemented: the DeepSeek-V2-Lite retained benchmark matrix emits `artifact_manifest.json` and `regression_summary.json`; PR #617 review follow-up is to keep regression comparability conservative for preserved setup failures and stable GPU metadata.
>
