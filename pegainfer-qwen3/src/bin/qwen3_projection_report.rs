...
use anyhow::Result;
use clap::Parser;
use pegainfer_qwen3::projection_report::ProjectionReportOptions;
use pegainfer_qwen3::projection_report::generate_projection_report;

#[derive(Debug, Parser)]
#[command(
    about = "Compare real-weight Qwen3 split/fused projections for one TP rank",
    after_help = "Example:\n  cargo run --release -p pegainfer-qwen3 \
